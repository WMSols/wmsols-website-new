  ...
  return (
    <div className="min-h-screen bg-gray-50 py-16 px-4 sm:px-6 lg:px-8 font-sans">
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 place-items-center lg:place-items-start lg:grid-cols-2 gap-24">
          ...
          <div className="pt-2">
            ...
            <div className="space-y-6 text-gray-500">
              <div className="flex items-start">
                <Mail className="w-5 h-5 mr-3 mt-0.5 text-gray-400" />
                <p>Email: info@wmsols.com</p>
              </div>
              <div className="flex items-start">
                <Phone className="w-5 h-5 mr-3 mt-0.5 text-gray-400" />
                <p>Phone: +1 (505) 386-1888</p>
              </div>
              <div className="flex items-start">
                <MapPin className="w-5 h-5 mr-3 mt-0.5 text-gray-400" />
                <p>
                  Address: 123 Tech Avenue, San Francisco,<br />
                  CA 94102
                </p>
              </div>
              <div className="flex items-start">
        ...
        <div className="fixed inset-0 z-100 flex items-center justify-center">
          ...
          <div className="relative bg-white rounded-xl shadow-2xl p-8 max-w-lg w-full mx-4 text-center z-10">
            ...
            <div className="flex items-center justify-center space-x-2 mb-4 mt-2">
              ...
              <h3 className="text-2xl font-bold text-gray-900">Message Recieved</h3>
            </div>
