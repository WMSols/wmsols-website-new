...
export default function CTASection() {
  return (
    <section 
      className="w-full min-h-150 flex flex-col md:gap-0 gap-20 md:flex-row bg-[linear-gradient(180deg,#050130_50%,#2776EA_50%)] md:bg-[linear-gradient(110deg,#050130_50%,#2776EA_50%)]"
    >
      {/* Left Section: Explore our Work */}
      <div className="flex-1 flex flex-col justify-center md:justify-start pt-16 md:pt-24  px-8 md:px-16 lg:px-24 text-white">
      ...
      <div className="flex-1 flex flex-col justify-center md:justify-end pb-16 md:pb-24  px-8 md:px-16 lg:px-24 text-white">
